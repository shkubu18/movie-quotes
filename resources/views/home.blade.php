...
@auth
        <div class="text-center">
            ...
            <a class="underline mr-5" href="/admin/movies/create">{{ __('header.add_movie') }}</a>
            <a class="underline mr-5" href="/admin/quotes/create">{{ __('header.add_quote') }}</a>
            <a class="underline mr-5" href="/admin/movies/dashboard">{{ __('header.movies_panel') }}</a>
            <a class="underline mr-5" href="/admin/quotes/dashboard">{{ __('header.quotes_panel') }}</a>
