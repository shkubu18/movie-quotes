@auth
    <header class="text-lg font-medium mx-5 text-center bg-gray-400 p-6 rounded-xl">
        <a class="mr-4" href="/admin/movies/create">{{ __('header.add_movie') }}</a>
        <a class="mr-4" href="/admin/quotes/create">{{ __('header.add_quote') }}</a>
        <a class="mr-4" href="/admin/movies/dashboard">{{ __('header.movies_panel') }}</a>
        <a class="mr-4" href="/admin/quotes/dashboard">{{ __('header.quotes_panel') }}</a>
